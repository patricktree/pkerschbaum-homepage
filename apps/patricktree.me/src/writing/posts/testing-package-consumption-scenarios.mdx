...
## Automating Consumption Tests with `@patricktree/pkg-consumption-test`

One tool that can help automate this is <FancyAnchor href="https://www.npmjs.com/package/@patricktree/pkg-consumption-test">`@patricktree/pkg-consumption-test`</FancyAnchor>. It is designed to automate the testing of these package consumption scenarios.
...
1.  Install the package as a dev dependency:
    ...
    # or using pnpm
    pnpm add --save-dev @patricktree/pkg-consumption-test
    # or using yarn
    yarn add --dev @patricktree/pkg-consumption-test
    ```
...
You can see several examples of such scenarios in <FancyAnchor href="https://github.com/patricktree/packages/tree/main/packages/typescript-eslint-rules-requiring-type-info/test-pkg-consumption-scenarios">this repository</FancyAnchor>.
...
`@patricktree/pkg-consumption-test` provides a structured and automated way to test if your npm packages work reliably across the diverse JavaScript ecosystem. By simulating real-world consumption patterns using a private registry, it helps catch integration issues early before publishing new versions.
